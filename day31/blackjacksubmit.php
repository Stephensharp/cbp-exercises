...
$pdo = new PDO('mysql:host=localhost;dbname=blackjack;charset=utf8', 'root', 'rootroot');
var_dump($pdo);

$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

if ($_POST) {
    $stmt = $pdo->prepare('INSERT INTO blackjack (deck) VALUES (?');
    $stmt->execute(array($_POST['deck']));
    header('Location: game.php'); //issues a new page request upon submission to save resubmitting
}
?>
